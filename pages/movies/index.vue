...
export default {
  ...
  computed: {
    popularTitle () {
      return getListItem('movies', 'popular').title;
    },

    popularUrl () {
      return { name: 'movies-category-name', params: { name: 'popular' } };
    },

    topRatedTitle () {
      return getListItem('movies', 'top_rated').title;
    },

    topRatedUrl () {
      return { name: 'movies-category-name', params: { name: 'top_rated' } };
    },

    upcomingTitle () {
      return getListItem('movies', 'upcoming').title;
    },

    upcomingUrl () {
      return { name: 'movies-category-name', params: { name: 'upcoming' } };
    },

    nowPlayingTitle () {
      return getListItem('movies', 'now_playing').title;
    },

    nowPlayingUrl () {
      return { name: 'movies-category-name', params: { name: 'now_playing' } };
    },
  },
