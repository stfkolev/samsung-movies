<template>
  <footer :class="$style.footer">
    <p>&copy; {{ new Date().getFullYear() }} Stf Kolev. All rights reserved. </p>
    <p>Designed and built by <a target="_blank" href="https://www.github.com/stfkolev" rel="noopener">Stf Kolev</a>, data provided by <a target="_blank" href="https://www.themoviedb.org/" rel="noopener">TMDb</a>.</p>

    <ul class="nolist">
      <li>
        <a
          href="https://twitter.com/stfkolev"
          target="_blank"
      ...
      <li>
        <a
          href="https://github.com/stfkolev"
          target="_blank"
      ...
      <li>
        <a
          href="https://www.linkedin.com/in/stfkolev"
          target="_blank"
