  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'author', name: 'author', content: 'Stf Kolev' },
      ...
      { hid: 'og:url', property: 'og:url', content: 'https://samsung-movies.herokuapp.com/' },
      { name: 'twitter:card', content: 'summary' },
      { name: 'twitter:title', content: 'Movies' },
      { name: 'twitter:description', content: 'Browse Movies, TV Shows and People' },
      { name: 'twitter:site', content: '@stfkolev' },
      { name: 'twitter:creator', content: '@stfkolev' },
      { name: 'twitter:image', content: 'https://samsung-movies.herokuapp.com/icon-medium.png' },
    ],
    link: [
